...
class ItemController extends Controller
{
        ...
        ->paginate(5);  
            ...
            if (\Auth::guard('admin')->check()) {
                return view('admin.index', compact('items'))
                    ->with('user_name', \Auth::guard('admin')->user()->name)
    ...
    public function create()
    {
        //bunruiテーブルのデータすべて渡す
        $bunruis = Bunrui::all();
        return view('admin.create', compact('bunruis'));
    ...
    public function show(Request $request, Item $item)
    {
        ...
        return view('admin.show', compact('item', 'bunruis', 'page'));
    }
    /**
    ...
    {
        $bunruis = Bunrui::all();
        return view('admin.edit', compact('item', 'bunruis'));
    }
